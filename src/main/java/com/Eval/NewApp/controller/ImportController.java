                    ...
                    while ((line = reader.readLine()) != null) {
                        ...
                        try {
                            ...
                            if (response.getStatusCode().is2xxSuccessful()) {
                                ...
                                results.add("Line " + lineNumber + ": Success: " + message + " (Employee ID: " + employeeId + ")");
                                ...
                                results.add("Line " + lineNumber + ": Failed to import employee: " + employeeData.get("employee_name") + " - " + error);
                            }
                        } catch (Exception e) {
                            results.add("Line " + lineNumber + ": Error importing employee: " + employeeData.get("employee_name") + " - " + e.getMessage());
                        }
                    }
                } catch (IOException e) {
            ...
            if (salaryStructureCsvFile != null && !salaryStructureCsvFile.isEmpty()) {
                ...
                try (BufferedReader reader = new BufferedReader(
                    ...
                    while ((line = reader.readLine()) != null) {
                        ...
                        String[] fields = line.split(",");
                        if (fields.length < 6) {
                            results.add("Line " + lineNumber + ": Error: Invalid CSV format, expected 6 fields, found " + fields.length);
                            continue;
                        }
                ...
                try {
                    ...
                    if (response.getStatusCode().is2xxSuccessful()) {
                        ...
                        if (structureResults.isEmpty()) {
                            results.add(message != null ? message : "Salary structure imported successfully with no issues");
                        } else {
                        ...
                        results.add("Error importing salary structure: " + error);
                    }
                } catch (Exception e) {
                    results.add("Error importing salary structure: " + e.getMessage());
                }
